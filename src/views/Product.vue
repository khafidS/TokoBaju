                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :items="4" :nav="false" :autoplay="true" :dots="false"> 
                                    <div class="pt mx-2" @click="changeImage(thumbs[0])" :class="thumbs[0] == gambar ? 'active':'' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt mx-2" @click="changeImage(thumbs[1])" :class="thumbs[1] == gambar ? 'active':'' ">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt mx-2" @click="changeImage(thumbs[2])" :class="thumbs[2] == gambar ? 'active':'' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt mx-2" @click="changeImage(thumbs[3])" :class="thumbs[3] == gambar ? 'active':'' ">
...
import HeaderMastore from '@/components/HeaderMastore.vue'
import FooterMastore from '@/components/FooterMastore.vue'
